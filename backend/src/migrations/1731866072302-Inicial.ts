...
export class Inicial1731866072302 implements MigrationInterface {
    name = 'Inicial1731866072302'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "resposta" ("id" SERIAL NOT NULL, "pergunta" character varying NOT NULL, "tipo" character varying NOT NULL, "pergunta_id" integer NOT NULL, "opcao_resposta" text, "opcao_resposta_escolhida" text, "resposta_livre" character varying, "respondido" boolean NOT NULL DEFAULT false, "dataResposta" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "questionarioId" integer, CONSTRAINT "PK_bf804c2c8d0434acf22e3e48f04" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "questionario" ("id" SERIAL NOT NULL, "usuarioId" integer NOT NULL, "respondido" boolean NOT NULL DEFAULT false, "peso" integer NOT NULL DEFAULT '0', "dataFinalizacao" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_522cf4010d557b73ad2ed728d96" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "user" ("id" SERIAL NOT NULL, "username" character varying NOT NULL, "userKey" character varying(32), "profilePicture" character varying NOT NULL DEFAULT 'default.jpg', "password" character varying NOT NULL, "email" text NOT NULL, "genero" text NOT NULL, "cpf" text NOT NULL, "dataNascimento" TIMESTAMP, "tipo" text NOT NULL, "paciente_ativo" boolean DEFAULT true, "topicosPaciente" text array NOT NULL DEFAULT '{Geral}', "crm" text, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "medicoId" integer, CONSTRAINT "UQ_78a916df40e02a9deb1c4b75edb" UNIQUE ("username"), CONSTRAINT "UQ_f895fe808c3662976bee0b530ec" UNIQUE ("userKey"), CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "UQ_a6235b5ef0939d8deaad755fc87" UNIQUE ("cpf"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
        await queryRunner.query(`ALTER TABLE "opcoes_resposta" ADD CONSTRAINT "FK_f299cd5ba0803a349a17547109a" FOREIGN KEY ("perguntaId") REFERENCES "pergunta"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
