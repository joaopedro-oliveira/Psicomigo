...
export type AdicionarResponse = {
  __typename?: 'AdicionarResponse';
...
export type Mutation = {
  ...
  adicionarPaciente: AdicionarResponse;
  ...
  editarPaciente: User;
  enviarLembretes: Scalars['Boolean'];
...
export type MutationAdicionarPacienteArgs = {
...
export type MutationEditarPacienteArgs = {
...
export type MutationEnviarLembretesArgs = {
...
export type RegularUserFragment = { __typename?: 'User', id: number, username: string, tipo: string, userKey?: string | null | undefined };

export type RegularUserResponseFragment = { __typename?: 'UserResponse', errors?: Array<{ __typename?: 'FieldError', field: string, message: string }> | null | undefined, user?: { __typename?: 'User', id: number, username: string, tipo: string, userKey?: string | null | undefined } | null | undefined };
...
export type AdicionarPacienteMutationVariables = Exact<{
  userkey: Scalars['String'];
}>;


export type AdicionarPacienteMutation = { __typename?: 'Mutation', adicionarPaciente: { __typename?: 'AdicionarResponse', sucesso: boolean, erro?: string | null | undefined } };
...
export type ChangePasswordMutation = { __typename?: 'Mutation', changePassword: { __typename?: 'UserResponse', errors?: Array<{ __typename?: 'FieldError', field: string, message: string }> | null | undefined, user?: { __typename?: 'User', id: number, username: string, tipo: string, userKey?: string | null | undefined } | null | undefined } };
...
export type EditarPacienteMutationVariables = Exact<{
  userId: Scalars['Int'];
  paciente_ativo: Scalars['Boolean'];
  topicos?: InputMaybe<Array<Scalars['String']> | Scalars['String']>;
}>;


export type EditarPacienteMutation = { __typename?: 'Mutation', editarPaciente: { __typename?: 'User', id: number, username: string, email: string, paciente_ativo: boolean, topicosPaciente: Array<string>, tipo: string, genero: string } };
...
export type LoginMutation = { __typename?: 'Mutation', login: { __typename?: 'UserResponse', errors?: Array<{ __typename?: 'FieldError', field: string, message: string }> | null | undefined, user?: { __typename?: 'User', id: number, username: string, tipo: string, userKey?: string | null | undefined } | null | undefined } };
...
export type RegisterMutation = { __typename?: 'Mutation', register: { __typename?: 'UserResponse', errors?: Array<{ __typename?: 'FieldError', field: string, message: string }> | null | undefined, user?: { __typename?: 'User', id: number, username: string, tipo: string, userKey?: string | null | undefined } | null | undefined } };
...
export type MeQuery = { __typename?: 'Query', me?: { __typename?: 'User', id: number, username: string, tipo: string, userKey?: string | null | undefined } | null | undefined };

export type MedicoQueryVariables = Exact<{ [key: string]: never; }>;


export type MedicoQuery = { __typename?: 'Query', medico?: { __typename?: 'User', id: number, username: string } | null | undefined };

export type PacientesDoutorQueryVariables = Exact<{ [key: string]: never; }>;


export type PacientesDoutorQuery = { __typename?: 'Query', pacientesDoutor?: Array<{ __typename?: 'User', id: number, username: string, cpf: string, dataNascimento?: any | null | undefined, paciente_ativo: boolean, topicosPaciente: Array<string> }> | null | undefined };
...
export type GetUserQuery = { __typename?: 'Query', user?: { __typename?: 'User', id: number, username: string, email: string, dataNascimento?: any | null | undefined, paciente_ativo: boolean, topicosPaciente: Array<string>, tipo: string, genero: string } | null | undefined };

export type EnviaNotificacaoSubscriptionVariables = Exact<{ [key: string]: never; }>;


export type EnviaNotificacaoSubscription = { __typename?: 'Subscription', enviaNotificacao: { __typename?: 'Notificacao', sound: string, title: string, body: string, userIds: Array<number>, data?: { __typename?: 'DataObject', key: string, value: string } | null | undefined } };
...
export const RespostaPadraoFragmentDoc = gql`
  ...
  respostas {
    ...
    `;
export const AdicionarPacienteDocument = gql`
    mutation adicionarPaciente($userkey: String!) {
  adicionarPaciente(userKey: $userkey) {
    sucesso
    erro
  }
}
    `;
export type AdicionarPacienteMutationFn = Apollo.MutationFunction<AdicionarPacienteMutation, AdicionarPacienteMutationVariables>;

/**
 * __useAdicionarPacienteMutation__
 *
 * To run a mutation, you first call `useAdicionarPacienteMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useAdicionarPacienteMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [adicionarPacienteMutation, { data, loading, error }] = useAdicionarPacienteMutation({
 *   variables: {
 *      userkey: // value for 'userkey'
 *   },
 * });
 */
export function useAdicionarPacienteMutation(baseOptions?: Apollo.MutationHookOptions<AdicionarPacienteMutation, AdicionarPacienteMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<AdicionarPacienteMutation, AdicionarPacienteMutationVariables>(AdicionarPacienteDocument, options);
      }
export type AdicionarPacienteMutationHookResult = ReturnType<typeof useAdicionarPacienteMutation>;
export type AdicionarPacienteMutationResult = Apollo.MutationResult<AdicionarPacienteMutation>;
export type AdicionarPacienteMutationOptions = Apollo.BaseMutationOptions<AdicionarPacienteMutation, AdicionarPacienteMutationVariables>;
...
export const EditarPacienteDocument = gql`
    mutation editarPaciente($userId: Int!, $paciente_ativo: Boolean!, $topicos: [String!]) {
  editarPaciente(
    userId: $userId
    paciente_ativo: $paciente_ativo
    topicos: $topicos
  ) {
    id
    username
    ...
    `;
export type EditarPacienteMutationFn = Apollo.MutationFunction<EditarPacienteMutation, EditarPacienteMutationVariables>;

/**
 * __useEditarPacienteMutation__
 *
 * To run a mutation, you first call `useEditarPacienteMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useEditarPacienteMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [editarPacienteMutation, { data, loading, error }] = useEditarPacienteMutation({
 *   variables: {
 *      userId: // value for 'userId'
 *      paciente_ativo: // value for 'paciente_ativo'
 *      topicos: // value for 'topicos'
 *   },
 * });
 */
export function useEditarPacienteMutation(baseOptions?: Apollo.MutationHookOptions<EditarPacienteMutation, EditarPacienteMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<EditarPacienteMutation, EditarPacienteMutationVariables>(EditarPacienteDocument, options);
      }
export type EditarPacienteMutationHookResult = ReturnType<typeof useEditarPacienteMutation>;
export type EditarPacienteMutationResult = Apollo.MutationResult<EditarPacienteMutation>;
export type EditarPacienteMutationOptions = Apollo.BaseMutationOptions<EditarPacienteMutation, EditarPacienteMutationVariables>;
...
export const MedicoDocument = gql`
    query medico {
  medico {
    id
    username
 ...
 * __useMedicoQuery__
 *
 * To run a query within a React component, call `useMedicoQuery` and pass it any options that fit your needs.
 * When your component renders, `useMedicoQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useMedicoQuery({
 *   variables: {
 *   },
 * });
 */
export function useMedicoQuery(baseOptions?: Apollo.QueryHookOptions<MedicoQuery, MedicoQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<MedicoQuery, MedicoQueryVariables>(MedicoDocument, options);
      }
export function useMedicoLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<MedicoQuery, MedicoQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<MedicoQuery, MedicoQueryVariables>(MedicoDocument, options);
        }
export function useMedicoSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<MedicoQuery, MedicoQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<MedicoQuery, MedicoQueryVariables>(MedicoDocument, options);
        }
export type MedicoQueryHookResult = ReturnType<typeof useMedicoQuery>;
export type MedicoLazyQueryHookResult = ReturnType<typeof useMedicoLazyQuery>;
export type MedicoSuspenseQueryHookResult = ReturnType<typeof useMedicoSuspenseQuery>;
export type MedicoQueryResult = Apollo.QueryResult<MedicoQuery, MedicoQueryVariables>;
